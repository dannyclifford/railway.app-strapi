...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Webinar', 'Workshop']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Hero_Section: Schema.Attribute.Component<'dynamic-zone.hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Sections: Schema.Attribute.DynamicZone<
      [
        ...
        'home.survey-section',
        'home.learn-from-each-other-section',
...
export interface ApiPageAboutUsPageAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Sections: Schema.Attribute.DynamicZone<
      ['home.about-us-section', 'home.partners-section']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPageClassroomPageClassroom extends Struct.SingleTypeSchema {
  collectionName: 'page_classrooms';
  info: {
    displayName: 'Page - Classroom';
    pluralName: 'page-classrooms';
    singularName: 'page-classroom';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::page-classroom.page-classroom'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPageContactUsPageContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Sections: Schema.Attribute.DynamicZone<
      ['shared.contact-section', 'home.learn-from-each-other-section']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiRightRight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::right.right'>;
...
export interface ApiRightsPageRightsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rights-page.rights-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    rights: Schema.Attribute.Relation<'oneToMany', 'api::right.right'>;
    Sections: Schema.Attribute.DynamicZone<
      [
        'home.call-to-action-section',
...
export interface ApiSurveyPageSurveyPage extends Struct.SingleTypeSchema {
  collectionName: 'survey_pages';
  info: {
    description: '';
    displayName: 'Page - Survey';
    pluralName: 'survey-pages';
    singularName: 'survey-page';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::page-classroom.page-classroom': ApiPageClassroomPageClassroom;
      ...
      'api::right.right': ApiRightRight;
      'api::rights-page.rights-page': ApiRightsPageRightsPage;
      'api::service.service': ApiServiceService;
      'api::survey-page.survey-page': ApiSurveyPageSurveyPage;
